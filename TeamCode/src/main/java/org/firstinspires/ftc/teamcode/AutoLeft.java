    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                if (190 >= JavaUtil.colorToHue(Colorseen) && JavaUtil.colorToHue(Colorseen) >= 130) {
                    dropoffcone();
                    ...
                    right.setPower(0);
                    sleep(30000);
                } else if (0 <= JavaUtil.colorToHue(Colorseen) && JavaUtil.colorToHue(Colorseen) <= 25 || 270 <= JavaUtil.colorToHue(Colorseen) && JavaUtil.colorToHue(Colorseen) <= 360) {
